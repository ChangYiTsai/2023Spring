...
##########
        # #power pellet proximity
        # x, y = state.getPacmanPosition()
        # grid = state.getCapsules() 
        # distances = [util.manhattanDistance((x, y), (px, py)) for px, py in grid]

        # if distances:
        #     features["closest-power-pellet"] = min(distances) /(walls.width * walls.height)
        # else:
        #     features["closest-power-pellet"] = 1
